...
#   sh -c "$(curl -fsSL https://raw.githubusercontent.com/xianshuli/ohmyzsh/master/tools/install.sh)"
# or via wget:
#   sh -c "$(wget -qO- https://raw.githubusercontent.com/xianshuli/ohmyzsh/master/tools/install.sh)"
# or via fetch:
#   sh -c "$(fetch -o - https://raw.githubusercontent.com/xianshuli/ohmyzsh/master/tools/install.sh)"
#
...
#   REPO    - name of the GitHub repo to install from (default: xianshuli/ohmyzsh)
